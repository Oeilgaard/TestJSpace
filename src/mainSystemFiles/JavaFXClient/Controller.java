...
//        st.play();
    ...
    private void changeScene(String sceneName) throws IOException, InterruptedException, IllegalBlockSizeException, BadPaddingException, ClassNotFoundException {
        ...
        switch (sceneName) {
            ...
            case GAME_SCENE: {
                ...
                card1.setImage(new Image("resources/" + model.cardsOnHand.get(0).toLowerCase() + ".jpg")); //"mainSystemFiles/JavaFXClient/resources/"
    ...
    public static void loadHand(ArrayList<String> hand, Parent root) {
        ...
        card1.setImage(new Image("resources/" + hand.get(0).toLowerCase() + ".jpg")); //mainSystemFiles/
        ImageView card2 = ((ImageView) root.lookup("#card2"));
        card2.setImage(new Image("resources/" + hand.get(1).toLowerCase() + ".jpg")); //mainSystemFiles/
    }
