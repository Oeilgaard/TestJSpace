...
public class GameCommunicationAgent implements Runnable{

    private Model model;

    GameCommunicationAgent(Model model){
        this.model = model;
    }
                    ...
                    switch ((String) field2) {
                        case "KING":
                            if (!field4.equals("")) {
                                ...
                                ImageView card1 = ((ImageView) model.currentRoot.lookup("#cur_card"));
                                card1.setImage(new Image("resources/" + model.cardsOnHand.get(0).toLowerCase() + ".jpg")); //main_system_files/
                            }
                            break;
                        case "PRINCE":
                            if (!field4.equals("")) {
